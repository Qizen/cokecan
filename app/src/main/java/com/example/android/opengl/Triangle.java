...
public class Triangle {
    ...
    public Triangle(float[] coord, float[] newColor){
    ...
    public void move()
    {
        triangleCoords[6] += 0.1;
        Log.w("triangle coord", "was " + (triangleCoords[6] - 0.1) + " now " + triangleCoords[6]);
    }
